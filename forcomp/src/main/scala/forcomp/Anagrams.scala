...
object Anagrams {
  ...
  def wordOccurrences(w: Word): Occurrences = 
    w.toLowerCase.toList.groupBy(x => x).toList.map {
  ...
  // first attempt
  //s.flatMap(wordOccurrences).sorted
